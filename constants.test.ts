...
describe('constants', () => {
  ...
  describe('input limits', () => {
    it('should have valid input limits', () => {
    ...
    it('should allow reasonable length for system instructions', () => {
      expect(MAX_INPUT_LENGTHS.systemInstruction).toBeGreaterThanOrEqual(1000);
    });
  });
