                    ...
                    <div className="space-y-4 mt-4 animate-fadeIn">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <span className={`text-[10px] ${customConfig.name.length >= MAX_INPUT_LENGTHS.name ? 'text-red-400' : 'text-gray-500'}`}>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <span className={`text-[10px] ${customConfig.systemInstruction.length >= MAX_INPUT_LENGTHS.systemInstruction ? 'text-red-400' : 'text-gray-500'}`}>
                         ...
                         <div>
                            <div className="flex justify-between items-center mb-1">
                                <label className="text-xs text-gray-400">Greeting Message</label>
                                <span className={`text-[10px] ${customConfig.greeting.length >= MAX_INPUT_LENGTHS.greeting ? 'text-red-400' : 'text-gray-500'}`}>
